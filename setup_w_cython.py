#!/usr/bin/env python
# Time-stamp: <2013-04-04 14:26:09 Tao Liu>
...
def main():
    ...
    if has_cython:
        ext_modules = [Extension("MACS2.cProb", ["MACS2/cProb.pyx"], libraries=["m"], include_dirs=numpy_include_dir ),
                       ...
                       Extension("MACS2.cSignal", ["MACS2/cSignal.pyx"], include_dirs=numpy_include_dir),
                       ...
                       Extension("MACS2.IO.cScoreCalculate", ["MACS2/IO/cScoreCalculate.pyx"], include_dirs=numpy_include_dir),
