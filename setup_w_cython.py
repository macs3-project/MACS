...
try:
    ...
    import distutils
    has_cython = False
    command_classes['build_ext'] = distutils.build_ext


# Check compatibility of -Ofast option
# For GCC, if >= 4.6, use -Ofast, otherwise -O3.
class build_ext_subclass(command_classes['build_ext']):
    def build_extensions(self):
        ...
        command_classes['build_ext'].build_extensions(self)
...
def main():
    ...
    if has_cython:
        ext_modules = [Extension("MACS2.Prob", ["MACS2/Prob.pyx"], libraries=["m"], include_dirs=numpy_include_dir ),
                       ...
                       Extension("MACS2.Pileup", ["MACS2/Pileup.pyx","MACS2/cPosValCalculation.pxd","MACS2/cPosValCalculation.c"], include_dirs=numpy_include_dir ),
                       ...
                       Extension("MACS2.Statistics", ["MACS2/Statistics.pyx", "MACS2/cStatistics.c"], libraries=["m"], include_dirs=["MACS2/",numpy_get_include()]),
                       ]
    else:
