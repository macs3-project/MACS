#!/usr/bin/env python
# Time-stamp: <2012-04-22 22:00:32 Tao Liu>
...
def main():
    ...
    if has_cython:
        ext_modules = [Extension("MACS2.cProb", ["MACS2/cProb.pyx"], libraries=["m"]),
                       ...
                       Extension("MACS2.IO.cScoreTrack", ["MACS2/IO/cScoreTrack.pyx"], include_dirs=[numpy_get_include()]),
        ...
        ext_modules = [Extension("MACS2.cProb", ["MACS2/cProb.c"], libraries=["m"]),
                       ...
                       Extension("MACS2.IO.cScoreTrack", ["MACS2/IO/cScoreTrack.c"], include_dirs=[numpy_get_include()]),
