...
Combine BEDGraphs of scores from replicates. Note: All regions on the same chromosome in the bedGraph file should be continuous
...
- `-i IFILE`: MACS score in bedGraph for each replicate. Require at least 2 files such as '-i A B C D'. REQUIRED
