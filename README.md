...
We introduce WACS (Weighted Analysis of ChIP-seq) which is an extension of the well-known peak caller, MACS2. It allows the use of “smart” controls to model the non-signal effect for 
