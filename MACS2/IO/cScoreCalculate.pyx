# cython: profile=True
# Time-stamp: <2013-03-28 17:30:00 Tao Liu>
...
cdef class ScoreCalculator:
    ...
    cdef:
        ...
        dict pvalue_stat                 # save pvalue<->length dictionary to calculate pvalue
    ...
    def __init__ (self, treat, ctrl, float treat_depth, float ctrl_depth, bool stderr_on = False, float pseudocount = 1.0 ):
        """Initialize.
        ...
        treat and ctrl are two FWTrackIII objects.
