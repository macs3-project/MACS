...
#    diffscore.print_diff_peaks()
    ...
    if options.store_bdg:
        ...
        ofhd_logLR = open(options.bdglogLR,"w")
        ofhd_pvalue = open(options.bdgpvalue,"w")
        ofhd_logFC = open(options.bdglogFC,"w")
